...
const FAQ_ITEMS = [
  ...
  { q: "Можно ли забрать товар самовывозом?", a: "Да, самовывоз возможен с нашего склада. Адрес: 296100, Республика Крым, г. Джанкой, ул. Промышленная, 13Б. Режим работы: пн–пт 8:00–18:00, сб 9:00–14:00." },
];
            ...
            <AnimSection>
              ...
              <div className="space-y-5 mb-8">
                {[
                  ...
                  { icon: "MapPin", label: "Адрес", val: "296100, Республика Крым, г. Джанкой, ул. Промышленная, 13Б", href: "#" },
